    ...
    <div id="app">
		...
		<span class="input-group-prepend" id="flightDate">
			<span class="input-group-text"><i class="fal fa-calendar"></i></span>
                                        ...
                                        <date name="flightDate" v-model="flightDate" autocomplete="off" class="form-control"
    ...
    <script>
        app = new Vue({
            ...
            data: {
                ...
                turnaroundType: '{{$turnaroundType or 0}}',
                flightType: '{{$flightType or 0}}',
                delayCode: '{{$delayCode or 0}}',
