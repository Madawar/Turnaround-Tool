<html>
<head>
    <link rel="stylesheet" href="{{base_path('public/css/bundle.css')}}" type="text/css" media="all"/>
    <link rel="stylesheet" href="{{base_path('public/css/dashboard.css')}}" type="text/css" media="all"/>
